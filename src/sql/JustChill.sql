...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `JustChill`.`Task_comment` ;

CREATE TABLE IF NOT EXISTS `JustChill`.`Task_comment` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  `Author` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_Task_comment_Member1_idx` (`Author` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `JustChill`.`View_type` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_View_type_View1_idx` (`View_id` ASC) VISIBLE,
  CONSTRAINT `fk_View_type_View1`
    FOREIGN KEY (`View_id`)
    REFERENCES `JustChill`.`View` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
START TRANSACTION;
USE `JustChill`;
INSERT INTO `JustChill`.`View_type` (`id`, `name`, `description`, `View_id`) VALUES (1, 'Dashboard', NULL, DEFAULT);
INSERT INTO `JustChill`.`View_type` (`id`, `name`, `description`, `View_id`) VALUES (2, 'Backlog', NULL, DEFAULT);
INSERT INTO `JustChill`.`View_type` (`id`, `name`, `description`, `View_id`) VALUES (3, 'Kanban', NULL, DEFAULT);
INSERT INTO `JustChill`.`View_type` (`id`, `name`, `description`, `View_id`) VALUES (4, 'Scrum', NULL, DEFAULT);
INSERT INTO `JustChill`.`View_type` (`id`, `name`, `description`, `View_id`) VALUES (5, 'Roadmap', NULL, DEFAULT);
