...
@startuml
    ...
    |Система|
        : Відкриває діалогове вікно для підтвердження запиту;

    |Користувач|
        : Натискає кнопку "Надіслати запит";
        note right #ffaaaa
        <b> Можлива
        <b> EX.DECLINE
        end note
    ...
    |Система|
        : Повідомляє користувача про успішну подачу заявки;
        : Надсилає запит менеджеру проекта;
...
@startuml
    ...
    |Система|
        : Виводить заявку користувача стати тімлідом;
    ...
    |Система|
        : Надає учаснику права тімліда;
        : Надсилає повідомлення учаснику, що його запит підтверджено;
...
@startuml
    ...
    |Користувач|
        : Натискає кнопку "Відхилити";
        
    |Система|
        : Надсилає повідомлення учаснику, що його запит відхилено;
